...
<body id="body">
    <div class="wrapper">
        ...
        <header class="header">
            ...
            <a id="header__button" class="popup__button button-block" href="#popup">Записаться</a>
        </header>
        ...
        <section id="program" class="program">
            ...
            <div class="image-slider swiper-container">
                <div class="image-slider__wrapper swiper-wrapper">
                    <div class="image-slider__slide swiper-slide">
                        <div id="imge-slider__image-1" class="imge-slider__image imge-slider__image-1">
                            ...
                            <a class="popup__button program__button1" href="#popup">Записаться</a>
                        </div>
                    </div>
                    <div class="image-slider__slide swiper-slide">
                    ...
                    <div class="image-slider__slide swiper-slide">
                        <div id="imge-slider__image-5" class="imge-slider__image imge-slider__image-5">
                            ...
                            <p class="image-slider__text"> Гидрореабилитация для особенных детей </p>
                            <a class="popup__button  program__button1" href="#popup">Записаться</a>
                        </div>
                    </div>
                </div>
                ...
                <a class="popup__button program-button" href="#popup">Записаться</a>
            </div>
        </section>
                ...
                <div class="container-block">
                    <div class="water_reg">
                        ...
                        <div class="water__button">
                            <a class="popup__button button-block" href="#popup">Записаться</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="recording" class="recording">
            <div class="recording__content">
                ...
                <h3 class="title__h3 recording__title">
            ...
            <!-- *Форма отправки -->
            <form class="popup__container" action="" method="post">
                <div class="form__block">
                <div id="recording__text" class="popup__container__item">
                    <label><input  id="recording__text" class="popup__input recording__text" type="text" name="username" maxlength="12"
                        placeholder="Ваше имя"></label>
                    <label><input id="recording__text" class="popup__input recording__text" type="tel" name="usertel" maxlength="11"
                        placeholder="Номер телефона"></label>
                </div>
                <div id="recording__text" class="popup__container__item popup__user-text">
                    <label><textarea name="usertext" placeholder="*Сообщение"></textarea></label>
                </div>
            </div>
                <!-- *Кнопка отправить -->
            <button type="submit" class="popup__button">Записаться</button>
            </form>
        ...
        <section class="receive">
            <div class="container">
                ...
                <a class="popup__button receive__button" href="#popup">Записаться</a>
        ...
        <section id="take" class="take">
            <div class="container">
                ...
                <div class="baby">
                    ...
                    <a id="take__button" class="popup__button button-block" href="#popup">Записаться</a>
                </div>
                <div class="child">
                    <h3 class="title__h3 title__baby">
                        Для детей постарше:
                ...
                <div class="parents">
                    ...
                    <a id="take__button-cild" class="popup__button button-block" href="#popup">Записаться</a>
                </div>
        ...
        <div id="popup" class="popup">
            <a href="#nul__el" class="popup__area"></a>
            <div class="popup__body">
                <div class="popup__content">
                    <a href="#nul__el" class="popup__close"> <img src="img/close.svg" alt=""> </a>
                    <h3 class="popup__title">
                        Запишитесь на 4 занятия
                        <span class="colortext__popup">со скидкой 20%</span>
                    </h3>

                    <!-- *Форма отправки -->
                    <form class="popup__container" name="aws" action="" method="post">
                        <div class="form__block">
                            <div class="popup__container__item">
                                <label><input class="popup__input" type="text" name="username" maxlength="12"
                                  placeholder="Ваше имя"></label>
                             <label><input class="popup__input" type="tel" name="usertel" maxlength="11"
                                   placeholder="Номер телефона"></label>
                            </div>
                            <div class="popup__container__item ">
                             <label><textarea class="popup__textarea" name="usertext" placeholder="*Сообщение"></textarea></label>
                            </div>
                        </div>

                        <div class="form__button">
                            <p class="popup__text">
                              <span class="popup__text-none">3 600 руб </span>
                              <span class="popup__text-now">2 880 руб </span>
                            </p>
                         <!-- *Кнопка отправить -->
                         <button type="submit" name="aws" class="popup__button">Записаться</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="footer__menu-nav">
                            ...
                            <div class="footer__massanger">
                                <ul>
                                    ...
                                    <li class="footer__tg">
                                        <a href="#" class="footer__a"><img src="img/tg.svg" alt=""> </a>
                                    </li>
                                </ul>
                            </div>
